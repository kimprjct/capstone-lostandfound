...
<body>
    ...
    <div class="contact-info">
        ...
        @endif
        <p><strong>Total Unclaimed Items:</strong> {{ $foundItems->count() }}</p>
    </div>
            ...
            @foreach($foundItems as $item)
                <div class="item-card">
                    ...
                    <div class="item-details">
                        ...
                        <p><span class="detail-label">Location Found:</span> {{ $item->location ?? 'N/A' }}</p>
                        <p><span class="detail-label">Date Found:</span> {{ $item->date_found ? $item->date_found->format('F d, Y') : 'N/A' }}</p>
                        <p><span class="detail-label">Found By:</span> {{ $item->user?->first_name }} {{ $item->user?->last_name }}</p>
    ...
    @else
        <div class="no-items">
            <h3>No unclaimed found items found.</h3>
            <p>All found items have been claimed or are under review.</p>
        </div>
    @endif

    <div class="footer">
        <p>This report was generated automatically by the Lost & Found Management System.</p>
        <p>If you recognize any of these items, please contact the organization directly to claim them.</p>
    </div>
