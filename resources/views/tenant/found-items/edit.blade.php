                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('tenant.found-items.show', $foundItem->id) }}" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors">
                    ...
                    <form action="{{ route('tenant.found-items.update', $foundItem->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-2">
                                <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Item Name/Title</label>
                                <input type="text" name="title" id="title" value="{{ old('title', $foundItem->title) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="date_found" id="date_found" value="{{ old('date_found', $foundItem->date_found->format('Y-m-d')) }}" max="{{ date('Y-m-d') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                            </div>

                            <div>
                                <label for="location" class="block text-sm font-medium text-gray-700 mb-1">Location Found</label>
                                <input type="text" name="location" id="location" value="{{ old('location', $foundItem->location) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="description" id="description" rows="5" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>{{ old('description', $foundItem->description) }}</textarea>
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="mb-3 flex items-center">
                                    <img src="{{ asset('storage/' . $foundItem->image) }}" alt="{{ $foundItem->title }}" class="h-24 w-auto rounded border border-gray-200 mr-3">
                                    <div>
                                        <p class="text-sm font-medium">Current Image</p>
                                        <div class="mt-1">
                                            <label for="remove_image" class="inline-flex items-center">
                                                <input type="checkbox" name="remove_image" id="remove_image" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Upload a new image of the found item (optional)</p>
                            </div>
                        </div>
